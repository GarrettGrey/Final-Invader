...
class ApplicationMain
{
	...
	{
		lime.system.System.__registerEntryPoint("FinalInvader", create);

		#if (js && html5)
		#if (munit || utest)
		lime.system.System.embed("FinalInvader", null, 500, 640);
		#end
		#else
		create(null);
		#end
	...
	public static function create(config):Void
	{
		...
		app.meta["file"] = "FinalInvader";
		app.meta["name"] = "FinalInvader";
